...
for i in encoded_chords:
    encoded_chord_string.append(str(i)) # TODO EZ ROSSZ
                                # LISTNEK KÉNE LENNI, NEM STRINGNEK, MIVEL PL 255 STRINGKÉNT 2, 5, 5-KÉNT ÉRTELMEZŐDIK, LISTÁNÁL PEDIG 255-NEK
...
for j in range(41, 50):
    ...
    #a.simulate() throws an exception 90% of the time, because of floating point rounding errors, because my transition matrix is too huge.
